...
Make sure to use the URL for your repository rather than the example provided: the only
difference should be your username instead of `YOUR_USER`.
...
Since you set up a passphrase, it will prompt for it.  If you completed advanced settings for your authentication, it 
